...
<head>
    <title>${applicationScope.urlMappingConstants.getTitle(PageNames.Edit_ADDRESS)}</title>
                                    ...
                                    <div class="dash__pad-1">
                                        ...
                                        <ul class="dash__f-list">
                                            ...
                                            <li>
                                                ...
                                                <a class="dash-active"
                                                   href="${applicationScope.urlMappingConstants.getControllerUrl(PageNames.ADDRESS_BOOK)}">Address
                                                    Book</a>
                                            <li>
                                        ...
                                        <form class="dash-address-manipulation" action="editAddress" method="post">
                                            <div class="gl-inline">
                                                <div class="u-s-m-b-30">
                                                    ...
                                                    <input class="input-text input-text--primary-style" type="text"
                                                           name="streetName" id="street-name"
                                                           value="${sessionScope.user.address.streetAddress}"></div>
                                                <div class="u-s-m-b-30">

                                                    <label class="gl-label" for="address-city"> City </label>

                                                    <input class="input-text input-text--primary-style" type="text"
                                                           id="address-city" name="addressCity"
                                                           value="${sessionScope.user.address.city}"></div>
                                            </div>
                                            <div class="gl-inline">
                                                <div class="u-s-m-b-30">
                                                    ...
                                                    <input class="input-text input-text--primary-style" type="text"
                                                           ...
                                                           value="${sessionScope.user.address.state}"></div>
                                                <div class="u-s-m-b-30">

                                                    <label class="gl-label" for="address-country">Country</label>

                                                    <input class="input-text input-text--primary-style" type="text"
                                                           id="address-country" name="addressCountry"
                                                           value="${sessionScope.user.address.country}"></div>
                                            </div>
                                            ...
                                            <div class="gl-inline">
                                                <div class="u-s-m-b-30">
                                                    ...
                                                    <input class="input-text input-text--primary-style" type="text"
                                                           id="address-zip" name="zipPostalCode"
                                                           value="${sessionScope.user.address.zipPostalCode}"></div>
                                            </div>
