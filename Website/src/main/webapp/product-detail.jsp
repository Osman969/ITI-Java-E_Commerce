                                ...
                                <c:otherwise>
                                    ...
                                    <div>
                                        <div class="pd-detail__inline">
                                            ...
                                            <span class="pd-detail__price">$${WebsiteConstants.defaultDecimalFormat.format(requestScope.product.price * (1-(requestScope.product.discountPercent/ 100.0)))}</span>
                                            ...
                                            <del class="pd-detail__del">
                                                $${WebsiteConstants.defaultDecimalFormat.format(requestScope.product.price)}</del>
                                        </div>
                                    </div>
                                </c:otherwise>
                            </c:choose>
                            ...
                            <div class="u-s-m-b-15">
                                <div class="pd-detail__inline">
                                        ...
                                        <span class="pd-detail__click-wrap"><i class="far fa-heart u-s-m-r-6"></i>
                                            ...
                                            <a href="${applicationScope.urlMappingConstants.getControllerUrl(PageNames.WISHLIST)}?ref=${requestScope.product.productId}">Add to Wishlist</a>
