...
<head>
    <title>${applicationScope.urlMappingConstants.getTitle(PageNames.CANCELLATIONS)}</title>
                                        ...
                                        <div class="dash__pad-1">
                                            ...
                                            <ul class="dash__f-list">
                                                ...
                                                <li>
                                                    ...
                                                    <a class="dash-active" href="${applicationScope.urlMappingConstants.getControllerUrl(PageNames.CANCELLATIONS)}">My
